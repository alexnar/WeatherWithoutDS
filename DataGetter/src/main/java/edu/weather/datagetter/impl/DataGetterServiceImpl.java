...
public class DataGetterServiceImpl implements DataGetterService {
    ...
    private static final String GET_HTML_ERROR = "Error getting page html";

    public StringBuilder getDataFromUrl(String url) throws DataHttpGetException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        HttpGet httpGet = new HttpGet("https://hc.apache.org/httpcomponents-client-ga/quickstart.html");
        ...
        try (CloseableHttpResponse response = httpclient.execute(httpGet)) {
            ...
            throw new DataHttpGetException(GET_HTML_ERROR);
